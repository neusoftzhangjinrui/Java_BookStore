...
//        跳到注册成功页面 regist_success.jsp
    ...
    protected void regist_ajax(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
...
//                调用Sservice保存到数据库
                ...
                resp.getWriter().println("{\"res\":" + registerState + "}");
